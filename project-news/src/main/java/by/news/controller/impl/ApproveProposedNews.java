...
public class ApproveProposedNews implements Command {
	...
	private static final String REDIRECT_GO_TO_PROPOSED_NEWS_PAGE = "frontController?command=go_to_proposed_news_page";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			newsService.updateNewsStatusWithNewDate(newsId, NEWS_STATUS_APPROVED);
			response.sendRedirect(REDIRECT_GO_TO_PROPOSED_NEWS_PAGE);
		} catch (
