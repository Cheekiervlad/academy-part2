...
public class GoToUpdatingNewsPage implements Command {
	...
	private static final String PATH = "/WEB-INF/jsp/news_updating_page.jsp";

	private static final String URL = "frontController?command=go_to_updating_news_page&news_id=";
